# ezdxf: MULTILEADER internals

- Source: https://ezdxf.readthedocs.io/en/stable/dxfinternals/entities/mleader.html#mleader-internals
- Fetched: 2026-02-17
...
1.  MULTILEADER has the alias name MLEADER which is accepted by any [reliable CAD application](https://ezdxf.readthedocs.io/en/stable/glossary.html#term-reliable-CAD-application), but all of them create the entity as MULTILEADER

2.  uses [raw-color](https://ezdxf.readthedocs.io/en/stable/glossary.html#term-raw-color) values to define colors
...
- [Tutorial for MultiLeader](https://ezdxf.readthedocs.io/en/stable/tutorials/mleader.html#tut-mleader)

- DXF Reference: [MLEADER](https://help.autodesk.com/view/OARX/2018/ENU/?guid=GUID-72D20B8C-0F5E-4993-BEB7-0FCF94F32BE0)

Example for [`ezdxf.entities.MLeaderContext`](https://ezdxf.readthedocs.io/en/stable/dxfentities/mleader.html#ezdxf.entities.MLeaderContext) created by BricsCAD:
